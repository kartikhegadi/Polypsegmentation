...
def main():
    ...
    # App title
    st.header("An Efficient Model For Polyp Detection Using Deep Learning Approach")

    # Embedding an image from a URL after the title
    image_url = "./Polyp-image/polypimage.png"
    ...
    if uploaded_files:
        if st.button('Process Images'):
            with st.spinner('Processing images...'):
                ...
                model_url = "./Polyp-image/model_training.png"  
                st.image(model_url,use_column_width=True)
                
    else:
        st.header("Model Prediction")
        modelpred_url = "./Polyp-image/model_prediction.png"  
        st.image(modelpred_url,use_column_width=True)


    #Adding kvasir and cvc-clinicDB
    st.header("Kvasir")
    kvasir_img = "./Polyp-image/kvasir.png"
    st.image(kvasir_img,use_column_width=True)

    st.header("CVC-ClinicDB")
    cvc_img = "./Polyp-image/cvc.png"
    st.image(cvc_img,use_column_width=True)
